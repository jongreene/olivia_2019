...
def clock():
	...
	draw.text((0, 12), 'You are', fill = "WHITE", font = font)
	draw.text((0, 36), 'Beautiful', fill = "WHITE",font = font)
	draw.text((0, 72), currentDT.strftime("%H:%M"), fill = "WHITE",font = font)
	draw.text((40, 100), currentDT.strftime("%S"), fill = "WHITE",font = font)
	OLED.Display_Image(image)
	OLED.Delay(1)
